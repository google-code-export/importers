...
class Hook2(importers_abc.ArchiveHook):
    ...
    def finder(self, archive, archive_path, location):
        ...
        return Sqlite3Importer(archive, archive_path, location)


class Sqlite3Importer(importers_abc.PyFileFinder, importers_abc.PyPycFileLoader):
